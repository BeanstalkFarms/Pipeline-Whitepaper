...
\begin{titlepage}
    \begin{center}
        ...
        \end{center}
        \vspace{0.0cm}
        \large{Publius and Silo Chad}
            
        \vspace{-0.25cm}
        \normalsize{beanstalk.publius@protonmail.com, silochad@bean.farm}
        ...
        \vspace{-0.25cm}
        \footnotesize{Modified:} \normalsize{November 28, 2022}
        
        \vspace{-0.25cm}
        \footnotesize{Whitepaper Version:} {\normalsize{1.0.1}}
        
        \vspace{-0.25cm}
        \footnotesize{Code Version:} {\normalsize{1.0.0}}{\fref{github.com/BeanstalkFarms/Pipeline}}
